...
This course is still subject to ongoing minor updates and revisions, but is now complete. This is the first iteration of the course, as delivered to [StatML](https://statml.io/) PhD students on 2023-05-18. Note that all materials are freely available, and the course is quite suitable for self-study. If you are self-studying, you should probably allow a full day (including laptop setup).
