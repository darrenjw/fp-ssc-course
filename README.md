...
This course is still subject to ongoing minor updates and revisions, but is now complete. The first iteration of the course was delivered to [StatML](https://statml.io/) PhD students on 2023-05-18. Note that all materials are freely available, and the course is quite suitable for self-study. If you are self-studying, you should probably allow a full day (including laptop setup).
...
* [Scala parallel programming crash course](Scala/md/Parallel.md)
